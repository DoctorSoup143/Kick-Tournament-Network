! function (e, t) {
    ...
    function l(e, t, n, r) {
        return Y(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], J() ? n["offset" + e] + r["margin" + ("Height" === e ? "Top" : "Left")] + r["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }

    function u() {
        var e = window.document.body,
            t = window.document.documentElement,
            n = J() && window.getComputedStyle(t);
        return {
    ...
    function v(e, t, o, i) {
        ...
        if ("viewport" === i) s = m(a);
            ...
            var p;
            "scrollParent" === i ? "BODY" === (p = r(n(e))).nodeName && (p = window.document.documentElement) : p = "window" === i ? window.document.documentElement : i;
            var l = h(p, a);
            if ("HTML" !== p.nodeName || g(a)) s = l;
                ...
                var d = u(),
                    c = d.height,
                    v = d.width;
                s.top += l.top - l.marginTop, s.bottom = c + l.top, s.left += l.left - l.marginLeft, s.right = v + l.left
            }
        }
    ...
    function x(e, t, n) {
        ...
        var r = O(e),
            ...
            a = i ? "height" : "width",
            p = i ? "width" : "height";
        return o[f] = t[f] + t[a] / 2 - r[a] / 2, o[s] = n === s ? t[s] - r[p] : t[E(s)], o
    }
    ...
    function C(e, t, n, o) {
        ...
        f.addEventListener(t, n, {
            passive: !0
        }), i || C(r(f.parentNode), t, n, o), o.push(f)
    }
    ...
    function D(e, t, n, o) {
        ...
        var i = r(e);
        return C(i, "scroll", n.updateBound, n.scrollParents), n.scrollElement = i, n.eventsEnabled = !0, n
    }
    ...
    function W(e, t) {
        Object.keys(t).forEach((function (n) {
            var r = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && S(t[n]) && (r = "px"), e.style[n] = t[n] + r
        }))
    }
    ...
    for (var R = Math.min, U = Math.floor, Y = Math.max, I = ["native code", "[object MutationObserverConstructor]"], q = "undefined" != typeof window, z = ["Edge", "Trident", "Firefox"], G = 0, V = 0; V < z.length; V += 1)
        if (q && 0 <= navigator.userAgent.indexOf(z[V])) {
            G = 1;
            break
        } var _, X = q && function (e) {
        ...
        ie = function () {
            function t(n, r) {
                ...
                K(this, t), this.scheduleUpdate = function () {
                    ...
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = n.jquery ? n[0] : n, this.popper = r.jquery ? r[0] : r, this.options.modifiers = {}, Object.keys($({}, t.Defaults.modifiers, i.modifiers)).forEach((function (e) {
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function (e, t) {
                    var n, r = t.offset,
                        ...
                        s = i.reference,
                        a = o.split("-")[0];
                    return n = S(+r) ? [+r, 0] : F(r, f, s, a), "left" === a ? (f.top += n[0], f.left -= n[1]) : "right" === a ? (f.top += n[0], f.left += n[1]) : "top" === a ? (f.left += n[0], f.top -= n[1]) : "bottom" === a && (f.left += n[0], f.top += n[1]), e.popper = f, e
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function (e, t) {
                    ...
                    var i = t.priority,
                        ...
                        s = {
                            primary: function (e) {
                                var n = f[e];
                                return f[e] < r[e] && !t.escapeWithReference && (n = Y(f[e], r[e])), Z({}, e, n)
                            },
                            secondary: function (e) {
                                var n = "right" === e ? "left" : "top",
                                    o = f[n];
                                return f[e] > r[e] && !t.escapeWithReference && (o = R(f[n], r[e] - ("right" === e ? f.width : f.height))), Z({}, n, o)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function (e, n) {
                    ...
                    var o = e.placement.split("-")[0],
                        ...
                        h = a ? "bottom" : "right",
                        m = O(r)[p];
                    s[h] - m < f[u] && (e.offsets.popper[u] -= f[u] - (s[h] - m)), s[u] + m > f[h] && (e.offsets.popper[u] += s[u] + m - f[h]);
                    var g = s[u] + s[p] / 2 - m / 2,
                        v = t(e.instance.popper, "margin" + l).replace("px", ""),
                        b = g - d(e.offsets.popper)[u] - v;
                    return b = Y(R(f[p] - m, b), 0), e.arrowElement = r, e.offsets.arrow = {}, e.offsets.arrow[u] = Math.round(b), e.offsets.arrow[c] = "", e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function (e, t) {
                    ...
                    return f.forEach((function (s, a) {
                        ...
                        (d || v || w) && (e.flipped = !0, (d || v) && (r = f[a + 1]), w && (i = function (e) {
            ...
            inner: {
                ...
                fn: function (e) {
                    ...
                    return o[f ? "left" : "top"] = i[n] - (s ? o[f ? "width" : "height"] : 0), e.placement = E(t), e.offsets.popper = d(o), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    var s, a, p = void 0 === f ? t.gpuAcceleration : f,
                        ...
                        g = A("transform");
                    if (a = "bottom" == h ? -l.height + d.bottom : d.top, s = "right" == m ? -l.width + d.right : d.left, p && g) u[g] = "translate3d(" + s + "px, " + a + "px, 0)", u[h] = 0, u[m] = 0, u.willChange = "transform";
                    else {
                        var v = "bottom" == h ? -1 : 1,
                            b = "right" == m ? -1 : 1;
