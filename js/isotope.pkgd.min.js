...
function (t, e) {
    ...
    function n(n) {
        if (i(), "string" == typeof n && (n = document.querySelector(n)), n && "object" == typeof n && n.nodeType) {
            ...
            var x = t(s.height);
            return !1 !== x && (u.height = x + (I ? 0 : p + _)), u.innerWidth = u.width - (m + v), u.innerHeight = u.height - (p + _), u.outerWidth = u.width + y, u.outerHeight = u.height + g, u
        }
    }
...
function (t, e) {
    ...
    return i.compatOptions.fitWidth = "isFitWidth", i.prototype._resetLayout = function () {
        ...
        for (var n = this._getColGroup(i), o = Math.min.apply(Math, n), s = n.indexOf(o), r = {
                ...
                y: o
            }, a = o + t.size.outerHeight, u = this.cols + 1 - n.length, h = 0; u > h; h++) this.colYs[s + h] = a;
        return r
        ...
        for (var u = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, h = r; a >= h; h++) this.colYs[h] = Math.max(u, this.colYs[h])
                ...
                return function (i, n) {
                    for (var o = 0; o < t.length; o++) {
                        var s = t[o],
                            r = i.sortData[s],
                            a = n.sortData[s];
                        if (r > a || a > r) return (r > a ? 1 : -1) * ((void 0 !== e[s] ? e[s] : e) ? 1 : -1)
                    }
                    return 0
                }
